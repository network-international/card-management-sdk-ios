...
internal struct Accounts: Codable, JSONEncodable, Hashable {
    ...
    internal var subAccounts: SubAccounts?

    internal init(accountNumber: String, customerId: String, rbsNumber: String? = nil, productCode: String, balances: Balances? = nil, subAccounts: SubAccounts? = nil) {
