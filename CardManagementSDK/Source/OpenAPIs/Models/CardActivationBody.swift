...
internal struct CardActivationBody: Codable, JSONEncodable, Hashable {
    ...
    internal init(cardIdentifierId: String, cardIdentifierType: String, cardSequenceNumber: String? = nil, cardExpiryDate: String? = nil) {
