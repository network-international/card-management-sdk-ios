//
// RefinanceTransactionResHeader.swift
//
...
internal struct RefinanceTransactionResHeader: Codable, JSONEncodable, Hashable {
    ...
    /** Static Value -  REQ_REFINANCE_TRANSACTION */
    ...
    internal init(msgId: String, msgType: String, msgFunction: String, srcApplication: String, targetApplication: String, timestamp: String, trackingId: String, bankId: String, instanceId: String) {
        self.msgId = msgId
