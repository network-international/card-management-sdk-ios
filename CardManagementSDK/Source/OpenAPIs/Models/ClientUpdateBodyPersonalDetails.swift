//
// ClientUpdateBodyPersonalDetails.swift
//
...
internal struct ClientUpdateBodyPersonalDetails: Codable, JSONEncodable, Hashable {
    ...
    static let dateOfBirthRule = StringRule(minLength: 1, maxLength: 10, pattern: nil)
    static let placeOfBirthRule = StringRule(minLength: 1, maxLength: 255, pattern: nil)
    static let languageRule = StringRule(minLength: 1, maxLength: 18, pattern: nil)
