...
internal struct ClientCreateResBody: Codable, JSONEncodable, Hashable {
    ...
    internal var personalDetails: ClientCreateResBodyPersonalDetails?
    internal var contactDetails: ClientCreateResBodyContactDetails?
    ...
    internal init(customerId: String, bankCode: String, externalClientNumber: String? = nil, cardName: String, personalDetails: ClientCreateResBodyPersonalDetails? = nil, contactDetails: ClientCreateResBodyContactDetails? = nil, addresses: [Addresses]? = nil, identityProofDocument: [IdentityProofDocument]? = nil, supplementaryDocuments: [SupplementaryDocuments]? = nil, employmentDetails: [EmploymentDetails]? = nil, customFields: [CustomFields]? = nil) {
