//
// UpdateLimitUsageDetailsBody.swift
//
...
internal struct UpdateLimitUsageDetailsBody: Codable, JSONEncodable, Hashable {
    ...
    internal var limit: UpdateLimits?

    internal init(cardIdentifierId: String, cardIdentifierType: String, limit: UpdateLimits? = nil) {
