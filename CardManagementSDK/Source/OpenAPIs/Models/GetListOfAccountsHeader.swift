...
internal struct GetListOfAccountsHeader: Codable, JSONEncodable, Hashable {
    ...
    /** Message functions: Should be  “REQ_LIST_OF_ACCOUNTS”  */
    ...
    internal init(msgId: String, msgType: String, msgFunction: String, srcApplication: String, targetApplication: String, timestamp: String, trackingId: String? = nil, bankId: String, instanceId: String? = nil) {
        self.msgId = msgId
