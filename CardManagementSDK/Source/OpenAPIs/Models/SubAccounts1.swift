...
internal struct SubAccounts1: Codable, JSONEncodable, Hashable {
    ...
    internal var subAccounts: SubAccounts2?

    internal init(accountNumber: String, customerId: String, rbsNumber: String? = nil, productCode: String, balances: Balances? = nil, subAccounts: SubAccounts2? = nil) {
