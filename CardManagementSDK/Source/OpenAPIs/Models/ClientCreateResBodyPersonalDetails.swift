//
// ClientCreateResBodyPersonalDetails.swift
//
...
internal struct ClientCreateResBodyPersonalDetails: Codable, JSONEncodable, Hashable {
    ...
    static let dateOfBirthRule = StringRule(minLength: 1, maxLength: 20, pattern: nil)
