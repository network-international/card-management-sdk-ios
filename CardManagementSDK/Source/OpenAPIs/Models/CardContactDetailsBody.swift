...
internal struct CardContactDetailsBody: Codable, JSONEncodable, Hashable {
    ...
    internal init(cardIdentifierId: String, cardIdentifierType: String? = nil) {
