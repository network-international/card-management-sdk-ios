...
internal struct SubAccounts: Codable, JSONEncodable, Hashable {
    ...
    internal var subAccounts: SubAccounts1?

    internal init(accountNumber: String, customerId: String, rbsNumber: String? = nil, productCode: String, balances: Balances? = nil, subAccounts: SubAccounts1? = nil) {
