...
internal struct SubAccounts2: Codable, JSONEncodable, Hashable {

    static let accountNumberRule = StringRule(minLength: 1, maxLength: 16, pattern: nil)
    static let customerIdRule = StringRule(minLength: 1, maxLength: 10, pattern: nil)
    ...
    internal var subAccounts: SubAccounts3?

    internal init(accountNumber: String, customerId: String, rbsNumber: String? = nil, productCode: String, balances: Balances? = nil, subAccounts: SubAccounts3? = nil) {
