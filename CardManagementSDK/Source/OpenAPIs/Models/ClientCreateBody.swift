...
internal struct ClientCreateBody: Codable, JSONEncodable, Hashable {
    ...
    internal var personalDetails: ClientCreateBodyPersonalDetails?
    internal var contactDetails: ClientCreateBodyContactDetails?
    ...
    internal init(customerId: String, bankCode: String, externalClientNumber: String? = nil, cardName: String, cardType: String, personalDetails: ClientCreateBodyPersonalDetails? = nil, contactDetails: ClientCreateBodyContactDetails? = nil, addresses: [Addresses]? = nil, identityProofDocument: [IdentityProofDocument]? = nil, supplementaryDocuments: [SupplementaryDocuments]? = nil, employmentDetails: [EmploymentDetails]? = nil, customFields: [CustomFields]? = nil) {
