...
internal struct CustomerDetailsResBody: Codable, JSONEncodable, Hashable {

    static let customerIdRule = StringRule(minLength: 1, maxLength: 20, pattern: nil)
    static let bankCodeRule = StringRule(minLength: 1, maxLength: 5, pattern: nil)
    ...
    internal init(customerId: String, bankCode: String, clientNumber: String? = nil, regNumber: String? = nil, cardName: String, personalDetails: PersonalDetails? = nil, contactDetails: ContactDetails? = nil, addresses: [Addresses]? = nil, identityProofDocument: [IdentityProofDocument]? = nil, supplementaryDocuments: [SupplementaryDocuments]? = nil, employmentDetails: [EmploymentDetails]? = nil, customFields: [CustomFields]? = nil) {
