...
internal struct CardStatusChangeHeader: Codable, JSONEncodable, Hashable {
    ...
    /** Static Value -  REQ_CARD_STATUS_CHANGE */
    internal var msgFunction: String
    /** Source requesting channel eg IVR Might change */
