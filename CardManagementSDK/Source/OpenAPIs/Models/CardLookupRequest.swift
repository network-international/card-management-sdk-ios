...
internal struct CardLookupRequest: Codable, JSONEncodable, Hashable {
    ...
    /** Optional - Public Key which will be used to encrypt the returned identifier. This public key must be directly linked to the private key you will use to decrypt the identifier in your application. If not provided, the data will be returned in clear text Supported Encryption:   RSA(4096)  */
    internal var publicKey: String?

    internal init(cardIdentifierType: CardIdentifierType, cardIdentifierId: String, publicKey: String? = nil) {
