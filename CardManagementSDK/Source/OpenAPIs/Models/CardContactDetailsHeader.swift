//
// CardContactDetailsHeader.swift
//
...
internal struct CardContactDetailsHeader: Codable, JSONEncodable, Hashable {
    ...
    /** Static Value -  REQ_CARD_CONTACT_DETAILS */
    ...
    /** The bank_id sent in the request will be sent back in response in this field Eg ABCD */
