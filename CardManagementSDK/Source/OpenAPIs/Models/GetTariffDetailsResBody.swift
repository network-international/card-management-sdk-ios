...
internal struct GetTariffDetailsResBody: Codable, JSONEncodable, Hashable {
    ...
    internal var tariffDetails: [TariffDetails]?

    internal init(cardIdentifierId: String, cardIdentifierType: String, tariffDetails: [TariffDetails]? = nil) {
        self.cardIdentifierId = cardIdentifierId
        self.cardIdentifierType = cardIdentifierType
        self.tariffDetails = tariffDetails
    }
    ...
    internal func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(tariffDetails, forKey: .tariffDetails)
    }
}
