//
// LookupCardIdentifierResHeader.swift
//
...
internal struct LookupCardIdentifierResHeader: Codable, JSONEncodable, Hashable {
    ...
    /** Message functions: Should be  “REP_LOOKUP_CARD_IDENTIFIER”  */
