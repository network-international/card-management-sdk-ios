...
internal struct CardActivationResHeader: Codable, JSONEncodable, Hashable {
    ...
    internal init(msgId: String, msgType: String, msgFunction: String, srcApplication: String, trackingId: String? = nil, bankId: String) {
        self.msgId = msgId
