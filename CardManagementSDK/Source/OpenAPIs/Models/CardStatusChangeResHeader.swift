//
// CardStatusChangeResHeader.swift
//
...
internal struct CardStatusChangeResHeader: Codable, JSONEncodable, Hashable {
    ...
    /** msg_type can hold 2 values TRANSACTION or ENQUIRY, the value must be sent as it is mentioned in the request */
    internal var msgType: String
    /** Default REP_CARD_STATUS_CHANGE */
