//
// SwitchRestrictionsUsageDetailsHeader.swift
//
...
internal struct SwitchRestrictionsUsageDetailsHeader: Codable, JSONEncodable, Hashable {
    ...
    /** Static Value -  REQ_ENABLE_DISABLE_RESTRICTION */
    ...
    internal init(msgId: String, msgType: String, msgFunction: String, srcApplication: String, targetApplication: String, trackingId: String? = nil, bankId: String, instanceId: String? = nil) {
        self.msgId = msgId
