//
// SwitchRestrictionsUsageDetailsResHeader.swift
//
...
internal struct SwitchRestrictionsUsageDetailsResHeader: Codable, JSONEncodable, Hashable {
    ...
    /** Default RES_ENABLE_DISABLE_RESTRICTION */
