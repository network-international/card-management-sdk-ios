//
// GetLimitUsageDetailsHeader.swift
//
...
internal struct GetLimitUsageDetailsHeader: Codable, JSONEncodable, Hashable {
    ...
    /** Static Value -  REQ_GET_LIMITER_USAGE_DETAILS */
    ...
    internal init(msgId: String, msgType: String, msgFunction: String, srcApplication: String, targetApplication: String, bankId: String) {
        self.msgId = msgId
